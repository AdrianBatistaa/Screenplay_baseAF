...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanAdrianWantsToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception{
        OnStage.theActorCalled("Adrian").wasAbleTo(OpenUp.thePage(),Login.
